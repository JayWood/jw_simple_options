...
class JW_SIMPLE_OPTIONS{
	...
	public function register_admin_deps(){		
		...
		$sdir = get_stylesheet_directory_uri();
		wp_register_style('spectrum', $sdir.'/lib/jw_simple_options/css/spectrum.css', '', '1.0.9');
		wp_register_script('spectrum', $sdir.'/lib/jw_simple_options/js/spectrum.js', array('jquery'), '1.0.9' );
		
		wp_register_style( $this->prefix.'admin_css', $sdir.'/lib/jw_simple_options/css/jw_simple_options.css', '', '1.0');
		wp_register_script( $this->prefix.'admin_js', $sdir.'/lib/jw_simple_options/js/jquery.jw_simple_options.js' , '', '1.0');
                ...
                <table class="form-table">
                	<tbody>
						...
						foreach ($this->options as $k => $v){
                            if($v['type'] == 'section') : ?>
                                <tr valign="top">
                                	<td colspan="2" class="jw_options_section"><h3 class="jw_options_section <?= $this->prefix.$k ?>"><?=$v['name'];?></h3></td>
                                </tr>
                                <? else: ?>
							<tr valign="top">
...
?>
>>>>>>> 901fb058a1036f4e5bc3e88da9af127e964a3cd6
